...
$(function() {
    var $room = $(".room");
    var $desktop = $(".desktop");
	var $wallpaperHidden = $(".wallpaper-hidden");
    var $apps = $(".apps");
...
$(function() {
	...
	var $team = $(".team");
	var $teamExplorer = $(".explorer-window.team-explorer");

	var $about = $(".about");
	var $aboutExplorer = $(".explorer-window.about-explorer");

	var $discord = $("#discord");
	var $discordExplorer = $(".explorer-window.discord-explorer");
	...
	$st1.mouseover(function() {
		$hoverable.css("opacity", "1");
	})

	$st1.mouseout(function() {
		$hoverable.css("opacity", "0");
	})

	$team.on("click", function() {
		bindExplorer($teamExplorer);
	})
	...
	$discord.on("click", function() {
		checkWorkApps($discordExplorer);
		bindExplorer($discordExplorer);
	}) 
